...
- (void)setupAppIcons {
    ...
    NSSet *holidayKeys = [NSSet setWithArray:@[@"BlackHistory",@"Holi",@"EarthHour",@"WomansDay",@"LunarNewYear",@"StPatricksDay",@"Christmas",@"NewYears",@"Halloween",@"Thanksgiving",@"ValentinesDay",@"Ramadan",@"Easter",@"Eid",@"Anzac",@"Diwali",@"MayTheFourth",@"MothersDay",@"CanadaDay",@"FathersDay",@"IndependenceDay",@"LaborDay",@"MemorialDay",@"VeteransDay",@"NationalDay",@"FlagDay",@"Juneteenth"]];
